...
function onCookieAccept() {
  var user_ip = '{$USER_IP|escape:'htmlall':'UTF-8'}';
  var user_agent = '{$USER_AGENT|escape:'htmlall':'UTF-8'}';
  var acceptance_date = new Date().toISOString().slice(0, 19).replace('T', ' ');

  fetch('{$BASE_URL|escape:'htmlall':'UTF-8'}modules/sfkcookiebanner/ajax.php', {
    method: 'POST',
    headers: {
